...
- **GitHub Actions CI/CD:** A pipeline runs automatically on every push, enforcing Python linting (`flake8`) and unit tests to ensure high-quality, deployable code.
